...
#define SPI_INTERRUPT_FEATURE_ENABLED        0x01
#define SPI_INTERRUPT_FEATURE_DISABLED       0x00
...
#define SPI_INTERRUPT_ENABLE_         SPI_INTERRUPT_FEATURE_ENABLED
...
#define USART_TX_FLAG_STATUS()       (PIR1bits.TXIF)
#if INTERRUPT_PRIORITY_FEATURE_ENABLED == INTERRUPT_PRIORITY_ENABLED
...
#define USART_RX_FLAG_STATUS()       (PIR1bits.RCIF)
#if INTERRUPT_PRIORITY_FEATURE_ENABLED == INTERRUPT_PRIORITY_ENABLED
...
#define SPI_FLAG_STATUS()       (PIR1bits.SSPIF)
#define SPI_CLEAR_FLAG()       (PIR1bits.SSPIF =0)

#if INTERRUPT_PRIORITY_FEATURE_ENABLED == INTERRUPT_PRIORITY_ENABLED
#define SPI_INTERRUPT_SET_HIGH_PRIORITY()  (IPR1bits.SSPIP = 1)
#define SPI_INTERRUPT_SET_LOW_PRIORITY()   (IPR1bits.SSPIP = 0)
#endif
#endif
